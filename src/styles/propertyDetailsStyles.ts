...
export const propertyDetailsStyles = StyleSheet.create({
  ...
  specInputKey: { flex: 1, marginRight: 6, marginBottom: 0, padding: 10, fontSize: 14, minWidth: 0 },
  specInputValue: { flex: 1.5, marginRight: 6, marginBottom: 0, padding: 10, fontSize: 14, minWidth: 0 },
