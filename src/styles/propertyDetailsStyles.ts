...
export const propertyDetailsStyles = StyleSheet.create({
  ...
  assetContainer: { backgroundColor: PALETTE.card, borderRadius: STYLES.borderRadius.small, borderWidth: 1, borderColor: PALETTE.border, marginBottom: 12, overflow: 'hidden' },
  ...
  specificationsBox: { backgroundColor: PALETTE.background, borderRadius: STYLES.borderRadius.small, padding: 12, borderWidth: 1, borderColor: PALETTE.border },
  ...
  historyEntry: { padding: 12, backgroundColor: PALETTE.card, borderRadius: STYLES.borderRadius.small, borderWidth: 1, borderColor: PALETTE.border },
  ...
  modalContainer: { width: '95%', maxWidth: 400, maxHeight: '80%', backgroundColor: PALETTE.card, borderRadius: STYLES.borderRadius.medium, padding: 16 },
  modalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 },
  modalTitle: { fontSize: 20, fontWeight: '600', color: PALETTE.textPrimary },
  closeButton: { padding: 8 },
  input: { backgroundColor: PALETTE.background, borderWidth: 1, borderColor: PALETTE.border, borderRadius: STYLES.borderRadius.small, padding: 16, fontSize: 16, marginBottom: 12 },
  submitButton: { backgroundColor: PALETTE.primary, borderRadius: STYLES.borderRadius.small, padding: 16, alignItems: 'center', marginTop: 16 },
  ...
  specRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 8, width: '100%' },
  specInputKey: { maxWidth: 80, marginRight: 6, marginBottom: 0, padding: 10, fontSize: 14, minWidth: 60, flexShrink: 0 },
  specInputValue: { flex: 1, marginRight: 6, marginBottom: 0, padding: 10, fontSize: 12, minWidth: 0 },
