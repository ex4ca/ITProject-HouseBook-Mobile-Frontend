...
export default function AssetAccordion({ asset, isExpanded, onToggle, onAddHistory }:{asset: AssetWithChangelog; isExpanded: boolean; onToggle: () => void; onAddHistory: (asset: AssetWithChangelog) => void;}) {
      ...
      {isExpanded && (
        <View style={styles.assetContent}>
          ...
          {latestChange ? (
            ...
            <Text style={styles.emptyText}>No accepted specifications yet.</Text>
          )}
